...
namespace Faker
{
    public class Faker
    {
        ...
        {
            var pluginsLoader = new PluginLoader("C:\\Users\\Mi\\Documents\\university\\MI5\\spp\\Faker\\Plugins");
        ...
        private static IEnumerable<ConstructorInfo> GetSortedConstructorInfos(Type type, IComparer<ConstructorInfo> constrCompare)
        {
